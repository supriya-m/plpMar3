...
<h1 style = "color : #ffffff; opacity : 1.9;">ACCOUNT CREATION</h1>
    <div class="input-info">
     ...
     <input type="text" name="LOB" placeholder="Business Segment" list="dr">
      <datalist id="dr">
      <option name = "BA" value = "Business Auto"></option>
      <option name = "Restuarant" value = "Restuarant"></option>
      <option name = "Apartment" value = "Apartment"></option>
      <option name = "GenerationMerchant" value = "Generation Merchant"></option>
      </datalist>
...
<h1 style = "color : #ffffff; opacity : 1.9;">PROFILE CREATION</h1>
    <div class="input-info">
        ...
        <i class="input"></i>
         <input type = "password"  name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,12}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder = "password" required>
      <input type="text" name="rolecode" placeholder="Role Code" list="lr">
      <datalist id="lr">
